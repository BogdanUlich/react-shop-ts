...
const LeftMenu = () => {
    ...
    return (
        <>
            <div className={classNames('fade', visibleMenu ? 'active' : '')} onClick={closemenu}></div>
            ...
            <div className={classNames('left-menu', visibleMenu ? 'active' : '')}>
                <div className="left-menu__header">
                    ...
                    <img src={times} alt="" className="left-menu__icon" onClick={closemenu} />
                </div>
                ...
                <div className="left-menu__body">
                    ...
                    <div className="left-menu__contacts">
                        <a href="" className="left-menu__link">
                            ...
                            <span className="left-menu__link-number">+380 (50) 300 00 00</span>
                        </a>
